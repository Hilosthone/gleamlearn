...
export default function ContactUs() {
   ...
   * Routes messages directly to gleamlearn.ai@gmail.com securely.
   */
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                We respond to all institutional and technical inquiries sent to <span className="font-semibold text-gray-900 dark:text-white">gleamlearn.ai@gmail.com</span> within 24 hours.
              </p>
            </div>
            ...
            <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <strong className="text-gray-900 dark:text-white">gleamlearn.ai@gmail.com</strong>
                </div>
              </div>
          ...
          <div className="lg:col-span-7 bg-gray-50 dark:bg-gray-950 p-6 sm:p-8 rounded-2xl border border-gray-200 dark:border-gray-800 relative">
            {isSubmitted && (
              <div className="absolute inset-0 bg-white/95 dark:bg-gray-950/95 backdrop-blur-md rounded-2xl flex flex-col items-center justify-center text-center p-6 z-20 space-y-3">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">Your inquiry has been successfully routed via <span className="font-semibold">gleamlearn.ai@gmail.com</span>.</p>
              </div>
            )}
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4">
              ...
              >
                {isSubmitting ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" /> Sending to gleamlearn.ai@gmail.com...
                  </>
                ) : (
                  <>
