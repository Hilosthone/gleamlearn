...
//               </a>
//               {/* Mail Icon */}
//               <a href="mailto:support@gleamlearn.ai" className="w-9 h-9 rounded-xl bg-gray-50 dark:bg-dark-bg border border-gray-200 dark:border-dark-border flex items-center justify-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:border-brand-blue transition-all shadow-sm" aria-label="Email">
...
//             <ul className="space-y-2.5 text-sm">
//               <li><span className="hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">Privacy Policy</span></li>
//               <li><span className="hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">Terms of Service</span></li>
//               <li><span className="hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">Academic Integrity</span></li>
//               <li><span className="hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">Support Center</span></li>
//               <li><span className="hover:text-gray-900 dark:hover:text-white transition-colors cursor-pointer">Contact Us</span></li>
//             </ul>
//           </div>
