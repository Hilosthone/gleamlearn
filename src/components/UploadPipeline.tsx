...
//                           className="text-xs text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-200 dark:border-dark-border/60"
//                         >
//                           {step.detail}
//                         </motion.p>
//                       )}
...
//                   className="text-brand-blue hover:text-brand-blue/80 font-semibold flex items-center gap-1 transition-colors"
//                 >
